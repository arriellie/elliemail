...
<head>
	...
	<!-- TutanotaTags -->
	<title>${env.mode === "App" || env.mode === "Desktop" ? "Ellie Mail" : "Ellie Mail: Login &amp; Sign up for free"}</title>
	<meta name="description" content="Sign-up for Ellie Mail: Get a free email account with quantum-safe encryption and best privacy for all your emails, calendars and contacts.">
	<meta name="application-name" content="Ellie Mail">
    ...
    <meta property="og:site_name" content="Ellie Mail">
