...
export default {
	...
	"keys": {
		...
		"defaultMailHandler_msg": "Register Ellie Mail as the default email handler, e.g. to open email address links. This operation may require administrator permissions.",
		...
		"updateAvailable_label": "Update for Ellie Mail available ({version})",
