...
export default {
	...
	"keys": {
		...
		"defaultMailHandler_msg": "Registriere Ellie Mail als das Standard-E-Mail-Programm, z.B. um E-Mail-Adress-Links zu öffnen. Diese Aktion könnte Administratorrechte erfordern.",
