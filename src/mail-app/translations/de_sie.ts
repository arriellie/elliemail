...
export default {
	...
	"keys": {
		...
		"defaultMailHandler_msg": "Registrieren Sie Ellie Mail als das Standard-E-Mail-Programm, z.B. um E-Mail-Adress-Links zu öffnen. Diese Aktion könnte Administratorrechte erfordern.",
		...
		"updateAvailable_label": "Neue Version für Ellie Mail verfügbar ({version})",
