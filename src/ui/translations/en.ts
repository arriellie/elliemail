...
export default {
	...
	"keys": {
		...
		"active_label": "Active",
		"activeMigrations_label": "Active migrations",
		...
		"upstreamDesktopReleaseAvailable_label": "Upstream desktop release available ({version})",
		"upstreamDesktopReleaseAvailable_msg": "A newer Tuta desktop release is available. Ellie Mail will not install it automatically.",
		"upstreamDesktopRelease_label": "Upstream desktop release",
		"upstreamDesktopReleaseInstructions_action": "View update instructions",
		"suppressUpstreamDesktopReleaseNotifications_action": "Don't notify again for this release",
		"upstreamDesktopReleaseNotificationsSuppressed_msg": "Notifications for this release are turned off.",
		...
		"cannotCopyToTrash_msg": "Cannot copy these items to Trash",
		...
		"cannotMoveToTrash_msg": "Cannot move these items to Trash",
		...
		"disableMigrationSyncForFolder_action": "Disable import for this folder",
		...
		"enableMigrationSyncForFolder_action": "Enable import for this folder",
		...
		"freeAccountInfo_msg": "Only one Free Tuta account is allowed per person. Free accounts may only be used for private communication. If you want to use Tuta for your business or as a freelancer, please order a paid plan. Please also note that Free accounts get deleted if you do not log in for six months.",
		...
		"getTutaMail_action": "Get Ellie Mail",
		...
		"importFileFailuresError_msg": "Failed to import {failedEventsCount} events from file \"{filename}\". {succeededEventsCount} successfully imported.",
		...
		"invalidSendLaterDate_msg": "Invalid schedule send date.",
		...
		"invitationMailBody_msg": "Hi,<br><br>I recently switched to Ellie Mail so Big Tech can no longer scan my communication. It’s private and secure by design, open source, free from ads, and easy to use.<br><br>Here’s my personal invite link:<br>{registrationLink}<br><br>You’ll get an extra free month on any yearly plan if you sign up through this link.<br><br>There’s also a free plan, so you can try it without committing to anything.<br><br>Best regards,<br>{username}",
		"invitationNote_msg": "Secured with <strong>Ellie Calendar:</strong>\n<br>\n{1}",
		"invite_alt": "Invite",
		...
		"matchMigrationFoldersToTutaMailSets_label": "Individually map folders",
		"matrix_label": "Matrix",
		...
		"migrationCertificateError_msg": "The IMAP server’s identity could not be verified. This could be because the IMAP server uses a self-signed SSL certificate, or an attacker is trying to intercept your connection. If you trust this server, you can connect anyway, or you can provide your own certificate file to verify its identity. How do you want to proceed?",
		...
		"migrationConfigInfo_msg": "Connection successful! Now configure your migration.\nPlease decide whether you would like to have a label applied to all imported mails.\nChoose if you want to import all mails under a single migration folder or individually map to your Tuta folders.",
		"migrationConfigInfoGmail_msg": "Connection successful!\nWe're now ready to import your Gmail mails. Your Gmail label structure will be preserved and mapped to new Tuta labels. The Trash and Spam folder will not be imported.",
		"migrationConfigLoading_msg": "Connecting to {provider} ...",
		"migrationConfigurationAddLabelInfo_msg": "A label is connected to a color to help you visually find your imported mails.",
		"migrationConfigurationLinkFoldersInfo_msg": "You can link each folder from your old account to a matching folder in your Tuta account.",
		"migrationConnectionCertError_msg": "We could not establish a connection to the IMAP server, as it uses a self-signed SSL certificate. Please contact your IMAP server admin.",
		"migrationCreateFolder_action": "Create folder",
		...
		"migrationFolderMapping_title": "Folder Mapping",
		...
		"migrationHostNotReachableError_msg": "We could not establish a connection to the IMAP server. Please verify that the provided IMAP server information is correct, and your network allows connections to this IMAP server. Please make sure potentially existing firewall rules are configured correctly.",
		"migrationIgnoreCertificateErrors_action": "Connect anyway",
		"migrationImapAccountHost_label": "IMAP server",
		"migrationImapAccountPassword_label": "Password",
		"migrationImapAccountPort_label": "Port",
		"migrationImapCredentials_title": "Please enter the IMAP credentials for the account you want to migrate away from.",
		"migrationImapImap_title": "IMAP Credentials",
		"migrationImapProvider_label": "IMAP",
		"migrationInfo_msg": "The Tuta One-Click Migration works seamlessly with most providers.\n\nWe guarantee a completely secure and private migration, where all your data is encrypted on your device and imported mails can never be read by us.\n\nMake the one click and Turn ON Privacy!",
		"migrationInProgressAccounts_msg": "{sourceAddress} to\n{tutaMailbox}",
		"migrationInProgressInfo_msg": "Imported {mailCount} mails ⋅ {completed} / {total} folders completed.",
		...
		"migrationRootMailFolderNameAlreadyExists_helpLabel": "The folder name you have entered already exists in your mailbox. Please choose a different name.",
		"migrationSetup_title": "Email Migration",
		"migrationSetupComplete_title": "Email migration started successfully!",
		"migrationSetupFinished_msg": "Your migration is running now!",
		"migrationStart_action": "Start new migration",
		"migrationStartedPostponed_msg": "The migration has been set up correctly, but emails cannot be imported at the moment, since {provider} postponed the migration. The migration will continue automatically when {provider} is ready.",
		"migrationSummaryAccount_label": "Account",
		"migrationSummaryImapAccountHost_label": "IMAP server",
		"migrationSummaryImportInformation_label": "Migrating to",
		"migrationSummarySourceInformation_label": "Migrating from",
		"migrationSyncFailure_msg": "Irrecoverable error encountered during the migration, please cancel the migration and start a new one.",
		...
		"movingItemCount_label": "Moving {count} item(s)",
		"name_label": "Name",
		...
		"no_label": "No",
		"noActiveMigrations_msg": "There are currently no active migrations.",
		...
		"openMailApp_msg": "This action will open Ellie Mail App, do you want to continue?",
		...
		"pauseMigration_action": "Pause migration",
		...
		"planselector_page_sovereignty2026_referred_title": "One-time offer: Save 50% now!",
		...
		"pricing.encryptedCalendar_tooltip": "All data in your Ellie Calendars are encrypted, even notifications are sent encrypted to your device.",
		...
		"pricing.generalDiscount_msg": "Get Ellie Mail & Ellie Calendar at a discount now!",
		...
		"pricing.subscriptionPeriodInfoBusiness_msg": "The subscription period is one month when paying monthly and one year when paying yearly. The plan will be renewed automatically at the end of the subscription period. All shown prices are net prices.",
		...
		"referAFriendSubTitle_label": "Help your friends move away from Big Tech with a private and secure mailbox from Tuta.",
		...
		"resumeMigration_action": "Resume migration",
		"resumeSetup_label": "Resume setup",
		"resyncMigration_action": "Resync migration",
		"retry_action": "Try again",
		"revealPassword_action": "Reveal the password",
		"revocation_action": "Submit Revocation",
		"revocation_text": "You can submit a subscription revocation if your account is on a personal paid plan within 14 days of its upgrade. Please provide the credentials for the account of which you want to revoke your subscription.",
		...
		"searchInOurApps_msg": "Faster and better email search is available with {link}!",
		...
		"sendLater_action": "Schedule send",
		"sendLaterDateInThePast_msg": "Send must be scheduled at least {1} minutes from now.",
		"sendLaterDateNotSet_msg": "Date to schedule send is not set.",
		...
		"sendOrSendLater_label": "Send/Schedule send",
		...
		"startingMigration_msg": "Starting migration ...",
		"startMigration_action": "Start migration",
		...
		"subscriptionSettingAliasPaidFeature_label": "Extra email addresses",
		"subscriptionSettingAliasPaidFeature_msg": "If you have set any extra email addresses please disable it in Settings > Email > Email addresses",
		"subscriptionSettingAppleWebsite_action": "Apple website",
		"subscriptionSettingCalendarsPaidFeature_label": "Calendars",
		"subscriptionSettingCalendarsPaidFeature_msg": "If you have created any additional calendars please disable them in calendar view",
		"subscriptionSettingCancelPageExplanation_msg": "<ul><li>Your subscription will remain active until {date}.</li><li>After that, your account will be downgraded to the free plan and all paid features will be deactivated.</li><li>If you are not using any paid features, the downgrade will happen automatically.</li><li>If you are using paid features, you must deactivate them before {date} to downgrade.</li></ul>",
		"subscriptionSettingCancelPageNote_msg": "Important: Free accounts that are not logged in at least once within 6 months will be deleted along with all their data.",
		...
		"subscriptionSettingCurrentSubscription_label": "Your current subscription period",
		"subscriptionSettingDomainPaidFeature_label": "Custom Domains",
		"subscriptionSettingDomainPaidFeature_msg": "If you have set up any custom domain please disable it in  Settings > Global settings > Custom email domains",
		...
		"subscriptionSettingInboxPaidFeature_label": "Inbox Rules",
		"subscriptionSettingInboxPaidFeature_msg": "If you have set an inbox rule please disable it in Settings > Email > Inbox rules",
		"subscriptionSettingLabelPaidFeature_label": "Labels",
		"subscriptionSettingLabelPaidFeature_msg": "If you have more than three labels please delete any extra labels",
		"subscriptionSettingManageSubscription_action": "Apple settings",
		"subscriptionSettingNewSubscription_label": "Your next subscription period",
		"subscriptionSettingOptionPage_subtitle": "Please choose an option",
		"subscriptionSettingOptionPageCancel_label": "Keep your current subscription and switch to the free plan after your current subscription ends.",
		...
		"subscriptionSettingsActiveState_label": "Active",
		"subscriptionSettingsCancelledState_label": "Cancelled",
		"subscriptionSettingsErrorPageCancel_subtitle": "Something went wrong during your cancellation",
		"subscriptionSettingsErrorPageCancel_title": "Cancellation error",
		"subscriptionSettingsErrorPageRevoke_subtitle": "Something went wrong during your revocation",
		"subscriptionSettingsErrorPageRevoke_title": "Revocation error",
		...
		"subscriptionSettingsKeep_action": "Keep subscription",
		"subscriptionSettingsKeep_msg": "Your subscription will resume. We will charge you at the end of your current period. Is that ok?",
		...
		"subscriptionSettingsSubtitle_label": "On this page you can manage your subscription",
		"subscriptionSettingsSuccessPageCancel_subtitle": "You have successfully cancelled your subscription",
		"subscriptionSettingsSuccessPageCancel_title": "Cancellation confirmation",
		"subscriptionSettingsSuccessPageRevoke_subtitle": "You have successfully revoked your subscription",
		"subscriptionSettingsSuccessPageRevoke_title": "Revocation confirmation",
		"subscriptionSettingStorageFeature_label": "Storage",
		...
		"subscriptionSettingUsersFeature_label": "Additional users",
		"subscriptionSettingUsersFeature_msg": "If you have booked any additional users please deactivate them in Settings > User management",
		"subscriptionSettingWhitelabelFeature_label": "Whitelabel",
		"subscriptionSettingWhitelabelFeature_msg": "If you have set a whitelabel please deactivate it in Settings > Whitelabel",
		"subscriptionStateCardCancel_action": "Cancel subscription",
		"subscriptionStateCardEdit_action": "Edit subscription",
		"subscriptionStateCardEndDate_label": "End date",
		"subscriptionStateCardRenewalDate_label": "Renewal date",
		"subscriptionStateCardResubscribe_action": "Resubscribe",
		"subscriptionStateCardRevoke_action": "Revoke subscription",
		"subscriptionStateCardStartDate_label": "Start date",
		"sunday_label": "Sunday",
		...
		"supportDownloadMailApp_msg": "You can access the response once support has replied in Ellie Mail using your Ellie Calendar credentials.",
		...
		"supportRequestReceived_msg": "We’re reviewing your issue and will get back to you shortly. Keep an eye on your Ellie Mail inbox!",
		...
		"widgetNoEventsToday_msg": "No events today",
