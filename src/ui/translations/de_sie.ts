...
export default {
	...
	"keys": {
		...
		"migrationAccountConnectionFailure_msg": "Während der intialisierung Ihres Accounts ist ein Fehler aufgetreten. Technischer Fehler: {error}",
		...
		"migrationRootMailFolderNameAlreadyExists_helpLabel": "Ein Ordner mit dem selben Name existiert bereits. Bitte wählen Sie einen anderen Ordner-Name.",
		"migrationSetup_title": "E-Mail Migration",
		"migrationSetupComplete_title": "E-Mail Migration erfolgreich gestartet!",
		"migrationSetupFinished_msg": "Ihre Migration läuft nun!",
