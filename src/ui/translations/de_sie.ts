...
export default {
	...
	"keys": {
		...
		"active_label": "Aktiv",
		"activeMigrations_label": "Aktive Migrationen",
		...
		"alternativePaymentMethods_label": "Alternative Zahlungsmethoden",
		...
		"upstreamDesktopReleaseAvailable_label": "Upstream-Desktop-Version verfügbar ({version})",
		"upstreamDesktopReleaseAvailable_msg": "Eine neuere Tuta-Desktop-Version ist verfügbar. Ellie Mail wird sie nicht automatisch installieren.",
		"upstreamDesktopRelease_label": "Upstream-Desktop-Version",
		"upstreamDesktopReleaseInstructions_action": "Update-Anweisungen anzeigen",
		"suppressUpstreamDesktopReleaseNotifications_action": "Für diese Version nicht mehr benachrichtigen",
		"upstreamDesktopReleaseNotificationsSuppressed_msg": "Benachrichtigungen für diese Version sind deaktiviert.",
		"available_label": "Verfügbar",
		"back_action": "Zurück",
		"baseTheme_label": "Basisfarbschema",
		"bcc_label": "Bcc",
		"beginTyping_msg": "Geben Sie Ihre Frage ein…",
		...
		"changePaymentInterval_action": "Zahlungsperiode ändern",
		...
		"clearCache_action": "Cache löschen",
		"clearCache_msg": "Alle heruntergeladenen Daten löschen. Gerätedaten, wie gespeicherte Anmeldedaten und verifizierte Kontakte, werden nicht gelöscht.",
		"clearCacheConfirm_msg": "Leeren des Caches führt zum Aktualisieren der App. ",
		...
		"collapseTransferStack_label": "Übertragungen ausblenden",
		"color_label": "Farbe",
		...
		"confirmCancelTransfers_action": "Übertragungen abbrechen",
		"confirmCancelTransfers_msg": "Möchten Sie wirklich {count} Übetragungen abbrechen?",
		...
		"contactSales_action": "Vertrieb kontaktieren",
		...
		"createNewFolderIn_label": "Erstelle neuen Ordner in {folderName}",
		...
		"defaultSenderMailAddress_label": "Standard-Absenderadresse",
		"defaultSenderMailAddressInfo_msg": "Voreingestellte Absenderadresse und -name für neue E-Mails. Sie können Ihren Absendernamen unten in der E-Mail-Adresstabelle konfigurieren.",
		...
		"disableMigrationSyncForFolder_action": "Import für diesen Ordner deaktivieren",
		...
		"downgradeFailed_msg": "Ihr Account konnte nicht auf Free zurückgesetzt werden. Sie können keine E-Mails mehr senden oder empfangen, bis Sie alle aktiven Premium-Funktionen deaktiviert haben.",
		...
		"emailSender_label": "Absenderadresse",
		"emailSenderBlacklist_action": "Immer Spam",
		"emailSenderDiscardlist_action": "Verwerfen",
		"emailSenderExistingRule_msg": "Es existiert bereits eine Regel für diese Absenderadresse.",
		"emailSenderInvalidRule_msg": "Die Regel für diese Absenderadresse ist nicht erlaubt.",
		...
		"emptyIcsFile_msg": "Die Datei war leer. Keine Ereignisse zu importieren.",
		"emptyShortcut_msg": "Der Shortcut ist leer",
		"emptyTitle_msg": "Der Titel ist leer.",
		"enableAnyway_action": "Trotzdem aktivieren",
		"enableMigrationSyncForFolder_action": "Import für diesen Ordner aktivieren",
		...
		"expandTransferStack_label": "Übertragungen ausklappen",
		...
		"exportingEmailsFailure_label": "{count} E-Mails fehlgeschlagen",
		...
		"failedToLoadAlarms_error": "Erinnerungen könnten nicht geladen werden",
		...
		"getTutaMail_action": "Holen Sie sich Ellie Mail",
		...
		"goToSetting_label": "Gehen Sie zu den Einstellungen",
		...
		"importAlarmsError_msg": "{amount} Alarme konnten nicht importiert werden.",
		...
		"importEventIcsDuplicate_msg": "{amount} von {total} Ereignissen sind in der Datei doppelt vorhanden. Duplikate werden nicht importiert. Es wird mit den verbleibenden Ereignissen fortgefahren...",
		...
		"incorrectRecoveryCodeFormat_msg": "Der eingegebene Code hat nicht das richtige Format. Bitte stellen Sie sicher, dass Sie den richtigen Wiederherstellungscode verwenden.",
		...
		"invitationMailBody_msg": "Hi,<br><br>ich bin vor Kurzem zu Ellie Mail gewechselt, damit Big Tech meine Kommunikation nicht mehr scannen kann. Es ist privat und sicher, Open Source, werbefrei und einfach zu bedienen.<br><br>Hier mein persönlicher Einladungslink:<br>{registrationLink}<br><br>Sie erhalten einen zusätzlichen Gratismonat für jedes Jahresabo, wenn Sie sich über diesen Link anmelden.<br><br>Es gibt auch ein kostenloses Abo, das Sie einfach mal ausprobieren können, ohne sich gleich festzulegen.<br><br>Liebe Grüße,<br>{username}",
		"invitationNote_msg": "Sicher gesendet mit <strong>Ellie Calendar:</strong>\n<br>\n{1}",
		"invite_alt": "Einladen",
		...
		"lastSelected_label": "Zuletzt ausgewählt (Default)",
		...
		"mailAuthFailed_msg": "Diese Nachricht ist möglicherweise gefälscht. Der Inhalt dieser Nachricht ist nicht vertrauenswürdig, da Absenderadresse oder Nachrichtentext gefälscht sein könnten!",
		"mailAuthMissing_label": "Wir konnten nicht prüfen, ob Absenderadresse und Inhalt dieser Nachricht gültig sind.",
		"mailAuthMissingWithTechnicalSender_msg": "Wir konnten nicht prüfen, ob Absenderadresse und Inhalt dieser Nachricht gültig sind. Der technische Absender ist: {sender}",
		...
		"manualUpdateNeeded_msg": "Etwas verhindert das Update.\n\nBitte laden Sie das Update unter {url} herunter und führen Sie es manuell durch.",
		...
		"matchMigrationFoldersToTutaMailSets_label": "Ordner individuell zuordnen",
		"matrix_label": "Matrix",
		...
		"migrationCancelConfirm_msg": "Sind Sie sicher, dass Sie diese Migration abschließen möchten? Dieser Schritt kann nicht rückgängig gemacht werden!",
		"migrationCannotMapSpamFolder_label": "Der Spam-Ordner kann nicht zugewiesen werden.",
		"migrationCannotMapSpamFolder_msg": "Der Spam-Ordner kann nur in den Tuta Spam-Ordner importiert werden, um die Qualität Ihres Spam-Filters zu gewährleisten.",
		"migrationCertificateError_msg": "Die Identität des IMAP-Servers konnte nicht überprüft werden. Dies kann daran liegen, dass Ihr IMAP-Server ein selbstsigniertes SSL-Zertifikat verwendet oder dass ein Angreifer versucht, Ihre Verbindung abzufangen. Wenn Sie Ihrem Server vertrauen, können Sie dennoch eine Verbindung herstellen oder eine eigene Zertifikatsdatei hochladen. Wie möchten Sie fortfahren?",
		"migrationCertificateSecurityWarning_title": "Sicherheitswarnung!",
		...
		"migrationConfigInfo_msg": "Verbindung erfolgreich hergestellt! Nun können Sie Ihre Migration konfigurieren.\nBitte wählen Sie, ob alle importierte E-Mails mit einem Label markiert werden sollen. Außerdem können Sie entscheiden, ob alle importierten E-Mails und Ordner unter einem Migrations-Ordner erscheinen sollen, oder Sie Ordner Ihres alten Accounts individuell Ordnern Ihres Tuta-Accounts zuordnen wollen.",
		"migrationConfigInfoGmail_msg": "Verbindung erfolgreich hergestellt! \nWir sind nun bereit Ihre E-Mails von Gmail zu importieren. Ihre Gmail Label-Struktur bleibt erhalten und wird entsprechend neuen Tuta-Labeln zugeordnet. Die beiden Ordner Papierkorb und Spam werden nicht importiert.",
		"migrationConfigLoading_msg": "Verbindung zu {provider} wird hergestellt ...",
		"migrationConfigurationAddLabelInfo_msg": "Ein Label mit einer Farbmarkierung hilft beim Finden von importierten E-Mails.",
		"migrationConfigurationLinkFoldersInfo_msg": "Sie können jedem Ordner aus Ihrem alten Account einen entsprechenden Ordner in Ihrem Tuta-Account zuordnen.",
		"migrationConnectionCertError_msg": "Leider konnte keine Verbindung zum IMAP-Server aufgebaut werden, da der Server ein selbstsigniertes SSL-Zertifikat verwendet. Bitte kontaktieren Sie Ihren IMAP-Server-Administrator.",
		"migrationCreateFolder_action": "Ordner erstellen",
		"migrationCreateMissingFolders_label": "Fehlende Ordner erstellen",
		"migrationCreatingMissingFolders_msg": "Fehlende Ordner werden erstellt ...",
		"migrationCredentials_title": "Account",
		...
		"migrationHostNotReachableError_msg": "Leider konnte keine Verbindung zum IMAP-Server aufgebaut werden. Bitte überprüfen Sie Ihre eingegebenen IMAP-Server Daten und stelle Sie sicher, dass in Ihrem Netzwerk Verbindungen zu diesem IMAP-Server erlaubt. Bitte überprüfen Sie auch, ob eventuelle Firewall-Regeln eine Verbindung verhindern.",
		"migrationIgnoreCertificateErrors_action": "Trotzdem verbinden",
		"migrationImapAccountHost_label": "IMAP-Server",
		"migrationImapAccountPassword_label": "Passwort",
		"migrationImapAccountPort_label": "Port",
		"migrationImapCredentials_title": "Bitte geben Sie die IMAP-Zugangsdaten für Ihren alten E-Mail Account ein, von welchem Sie zu uns wechseln möchten.",
		"migrationImapImap_title": "IMAP-Zugangsdaten",
		"migrationImapProvider_label": "IMAP",
		"migrationInfo_msg": "Die Tuta Ein-Klick-Migration funktioniert nahtlos mit fast allen E-Mail Anbietern.\n\nWir garantieren eine komplett sichere und private Migration, bei welcher alle Ihre Daten auf Ihrem Gerät verschlüsselt werden und selbst wir als Tuta können importierte E-Mails niemals lesen.\n\nMachen Sie den Klick und schalten Sie Ihre Privatsphäre EIN!",
		...
		"migrationInProgressInfoGmail_msg": "{mailCount} E-Mails importiert.",
		...
		"migrationMailFolderNameGmail_helpLabel": "Sie können einen Namen für Ihren Migrations-Ordner festlegen. Alle Ihre Gmail E-Mails werden in diesen Ordner importiert.",
		...
		"migrationOAuthNetworkDiscoveryFailure_msg": "Beim laden der OAuth-Konfiguration ist ein Fehler aufgetreten.\nBitte überprüfen Sie, das in Ihrem Netzwerk Verbindungen zur folgender URL erlaubt sind:\n{url}",
		"migrationOAuthWindowClosedFailure_msg": "Das Login-Fenster wurde ohne Erfolg geschlossen. Bitte versuchen Sie es erneut.",
		...
		"migrationRootMailFolderName_helpLabel": "Bitte geben Sie einen Namen für Ihren Migrations-Ordner ein. Alle Ihre Ornder und E-Mails werden unterhalb dieses Ordners importiert.",
		"migrationRootMailFolderName_label": "Name für den Migrations-Ordner",
		"migrationRootMailFolderNameAlreadyExists_helpLabel": "Ein Ordner mit demselben Namen existiert bereits. Bitte wählen Sie einen anderen Ordner-Namen.",
		"migrationSetup_title": "E-Mail Migration",
		"migrationSetupComplete_title": "E-Mail Migration erfolgreich gestartet!",
		"migrationSetupFinished_msg": "Ihre Migration läuft jetzt!",
		"migrationStart_action": "Neue Migration starten",
		"migrationStartedPostponed_msg": "Die Migration wurde erfolgreich eingerichtet, jedoch können aktuell keine E-Mails importiert werden, da {provider} die Migration aufgeschoben hat. Die Migration wird automatisch vorgesetzt sobald {provider} bereit ist.",
		"migrationSummaryAccount_label": "Account",
		...
		"moreEmailsAvailable_msg": "Weitere Emails verfügbar",
		...
		"movingItemCount_label": "Verschiebe {count} Objekt(e)",
		"name_label": "Name",
		"nameSuffix_placeholder": "Namenszusatz",
		"nativeFileUploadTooLarge_msg": "veraltet – bitte entfernen",
		...
		"no_label": "Nein",
		"noActiveMigrations_msg": "Es sind aktuell keine Migrationen aktiv.",
		...
		"notAllMailsSearchable_msg": "Nicht alle Emails sind suchbar.",
		...
		"openMailApp_msg": "Diese Aktion öffnet die Ellie Mail App, möchten Sie fortfahren?",
		"openNewWindow_action": "Neues Fenster",
		"openProxystore_action": "ProxyStore öffnen",
		...
		"parentLabel_label": "Übergeordnetes Label",
		...
		"pauseMigration_action": "Migration pausieren",
		...
		"planselector_page_sovereignty2026_referred_subtitle": "Wechsel zu Tuta Mail und werde digital souverän. Nutze jetzt dieses einmalige Angebot und befreie dich von US-Datenkraken.",
		"planselector_page_sovereignty2026_referred_title": "Einmaliges Angebot: Spare jetzt 50%!",
		"planselector_page_sovereignty2026_subtitle": "Wechsel zu Tuta Mail mit 50% Rabatt! Nutze jetzt dieses einmalige Angebot und befreie dich von US-Datenkraken.",
		"planselector_page_sovereignty2026_title": "Wähle Digitale Souveränität",
		...
		"pricing.bonusMonthWithCampaign_label": "Bonus: {months} Monat(e) gratis!",
		...
		"pricing.generalDiscount_msg": "Holen Sie sich Ellie Mail & Ellie Calendar jetzt mit Rabatt!",
		...
		"pricing.saveAmountNow_label": "Sparen Sie jetzt {amount}!",
		...
		"pricing.subscriptionPeriodInfoBusiness_msg": "Die Vertragslaufzeit beträgt einen Monat bei monatlicher Zahlung und ein Jahr bei jährlicher Zahlung. Die Vertragslaufzeit wird nach Ende der Laufzeit automatisch verlängert. Alle gezeigten Preise sind Nettopreise.",
		...
		"proxyStorePayment_msg": "Sie können Ihren Plan mit Bargeld oder Kryptowährungen per Geschenkarte über unseren Partner ProxyStore upgraden",
		...
		"rebuildSearchIndex_action": "Suchindex neu erstellen",
		...
		"referAFriendBothBenefit_label": "machen Sie die Welt ein bisschen sicherer und privater",
		"referAFriendBothBenefit_title": "Zusammen",
		"referAFriendFriendBenefit_label": "Einen gratis Extra-Monat im jährlichen Abonnement",
		"referAFriendFriendBenefit_title": "Ihre Freunde bekommen:",
		"referAFriendMoreInfo_label": "Mehr über unser Empfehlungsprogramm:",
		"referAFriendOwnBenefit_label": "Tuta-Gutschrift in Höhe von 25% der ersten Zahlung Ihrer Freunde und gutes Karma für das Verbreiten der Botschaft",
		"referAFriendOwnBenefit_title": "Sie bekommen:",
		"referAFriendSubTitle_label": "Helfen Sie Ihren Freunden dabei, sich mit einer privaten und sicheren Tuta-Mailbox von Big Tech zu befreien.",
		...
		"rejectedSenderListInfo_msg": "Liste der E-Mails, die von den Tuta E-Mail-Servern abgelehnt wurden. Um die Zustellung zu erlauben kann eine Spam-Regel für die Absenderadresse angelegt werden.",
		...
		"reloadList_action": "Liste neu laden",
		...
		"resumeMigration_action": "Migration fortsetzen",
		"resumeSetup_label": "Konfiguration abschließen",
		"resyncMigration_action": "Migration erneut synchronisieren",
		"retry_action": "Wiederholen",
		"revealPassword_action": "Passwort anzeigen",
		"revocation_action": "Widerruf absenden",
		"revocation_text": "Sie können Ihr Abonnement widerrufen, wenn Ihr Account innerhalb von 14 Tagen nach dem Upgrade ein privates bezahltes Abo nutzt. Bitte geben Sie die Zugangsdaten für den Account an, dessen Abonnement Sie widerrufen möchten.",
		...
		"revocationOnlyPersonalPlans_msg": "Widerrufe können nur für private Abos eingereicht werden. Bitte kontaktieren Sie den Support, wenn Sie Hilfe benötigen.",
		"revocationPeriodEnded_msg": "Dieser Account befindet sich nicht mehr innerhalb der zweiwöchigen Widerrufsfrist. Sie können Ihren Vertrag in den App-Einstellungen regulär kündigen.",
		...
		"revokeSubscriptionWithAppStoreSubscription_msg": "Ihr Abonnement wird über den Apple App Store verwaltet. Sie müssen es dort widerrufen. Siehe {AppStorePayment}",
		"richNotifications_title": "Vollständige Push-Benachrichtigungen",
		"richNotificationsNewsItem_msg": "Ihre Ellie Mail-App kann jetzt Betreff & Absender in den Benachrichtigungen anzeigen! Aktivieren Sie diese Funktion jetzt:",
		...
		"sendDate_label": "Absendedatum",
		"sender_label": "Absenderadresse",
		...
		"setAsSenderNameForPrimaryAddress_label": "Als Absendername für die primäre E-Mail-Adresse festlegen.",
		...
		"startingMigration_msg": "Migration wird gestartet ...",
		"startMigration_action": "Migration starten",
		"startTime_label": "Startzeit",
		"startTimeZone_title": "Startzeitzone",
		...
		"subscriptionChangeInterval_msg": "Bei der nächsten Abo-Verlängerung wird Ihre Zahlungsperiode auf {period} gesetzt. Ist das okay?",
		"subscriptionChangePeriod_msg": "Ihr Abonnement wird nach Ablauf des aktuellen Abrechnungszeitraums ({1}) angepasst.",
		"subscriptionSettingAliasPaidFeature_label": "Weitere E-Mail-Adressen",
		"subscriptionSettingAliasPaidFeature_msg": "Falls Sie weitere E-Mail-Adressen konfiguriert haben, löschen Sie diese bitte unter Einstellungen > E-Mail > E-Mail-Adressen",
		"subscriptionSettingAppleWebsite_action": "Apple-Website",
		"subscriptionSettingCalendarsPaidFeature_label": "Kalender",
		"subscriptionSettingCalendarsPaidFeature_msg": "Wenn Sie mehr als einen Kalender haben, löschen Sie die Überzähligen bitte in der Kalenderansicht.",
		"subscriptionSettingCancelPageExplanation_msg": "<ul><li>Ihr Abo bleibt bis zum {date} aktiv.</li><li>Danach wird Ihr Account zu Free gewechselt und alle bezahlten Features werden deaktiviert.</li><li>Falls Sie keine bezahlten Features mehr verwenden, passiert der Wechsel zu Free automatisch.</li><li>Falls Sie bezahlte Features beutzen, müssen Sie diese bis zum {date} deaktivieren, damit der Wechsel zu Free automatisch passiert.</li></ul>",
		"subscriptionSettingCancelPageNote_msg": "Wichtig: Free Accounts, welche 6 Monate lang nicht benutzt wurden, werden nach diesen 6 Monaten mit allen Daten gelöscht.",
		"subscriptionSettingCancelSubscriptionOnlyFeatures_msg": "Falls Sie eine der folgenden Features benutzen, deaktiviere Sie diese bitte, bevor Ihr Abo ausläuft. Sonst ist es nicht möglich, Ihren Account zu Free zu wechseln und Sie müssen den Wechsel manuell vornehmen.",
		"subscriptionSettingCurrentSubscription_label": "Ihr aktueller Abo-Zeitraum",
		"subscriptionSettingDomainPaidFeature_label": "Eigene Domains",
		"subscriptionSettingDomainPaidFeature_msg": "Wenn Sie eigene Domains eingerichtet haben, löschen Sie diese bitte unter Einstellungen > Globale Einstellungen > Eigene E-Email Domains",
		"subscriptionSettingDowngrade_action": "Auf Free wechseln",
		"subscriptionSettingExpiredSubscriptionOnlyFeatures_msg": "Wir konnten Ihren Account nicht auf Free umstellen, weil Sie noch bezahlte Features nutzen. Bitte deaktiviere Sie diese, bevor Sie den Wechsel auf Free noch mal versuchen.",
		"subscriptionSettingInboxPaidFeature_label": "Posteingangsregeln",
		"subscriptionSettingInboxPaidFeature_msg": "Wenn Sie Posteingangsregeln definiert haben, löschen Sie diese bitte unter Einstellungen > E-Mail > Posteingangsregeln",
		"subscriptionSettingLabelPaidFeature_label": "Labels",
		"subscriptionSettingLabelPaidFeature_msg": "Falls Sie mehr als drei Labels haben, löschen Sie die Überzähligen bitte.",
		"subscriptionSettingManageSubscription_action": "Apple-Einstellungen",
		"subscriptionSettingNewSubscription_label": "Ihr nächster Abo-Zeitraum",
		"subscriptionSettingOptionPage_subtitle": "Bitte wählen Sie eine Option",
		"subscriptionSettingOptionPageCancel_label": "Behalten Sie Ihr aktuelles Abo und wechseln Sie zu Free nachdem Ihr Abo-Zeitraum abgelaufen ist",
		"subscriptionSettingOptionPageRevoke_action": "Rückerstattung (Vertrag widerrufen)",
		"subscriptionSettingOptionPageRevoke_label": "Widerrufen Sie Ihren Vertrag und erhalten Sie eine Rückerstattung. Nur möglich in den ersten 14 Tagen nach Beginn Ihres Abos",
		"subscriptionSettingResponderFeature_label": "Autoresponder",
		"subscriptionSettingResponderFeature_msg": "Falls Sie einen Autoresponder aktiviert haben, deaktivieren Sie diesen bitte unter Einstellungen > E-Mail > Autoresponder",
		"subscriptionSettingRevocationSubscriptionOnlyFeatures_msg": "Falls Sie eine der folgenden Features benutzen, deaktiviere Sie diese bitte. Anderenfalls ist es uns nicht möglich, Ihren Account zu Free zu wechseln und Sie müssen den Wechsel manuell vornehmen.",
		"subscriptionSettingRevokePageExplanation_msg": "<ul><li>Sie haben das Recht Ihren Vertrag innerhalb von 14 Tagen nach dem Kauf zu widerrufen.</li><li>Bei einem Widerruf wird Ihr Vertrag gekündigt und Sie erhalten eine Rückerstattung.</li><li>Ihr Account wird nach dem der Widerruf abgeschlossen ist, auf Free umgestellt.</li><li>Falls Sie noch bezahlte Features benutzen, müssen Sie diese vor dem Widerruf deaktivieren.</li></ul>",
		"subscriptionSettings_label": "Abonnement-Einstellungen",
		"subscriptionSettingsActiveState_label": "Aktiv",
		"subscriptionSettingsCancelledState_label": "Gekündigt",
		"subscriptionSettingsErrorPageCancel_subtitle": "Etwas ist bei Ihrer Kündigung fehlgeschlagen",
		"subscriptionSettingsErrorPageCancel_title": "Fehler bei der Kündigung",
		"subscriptionSettingsErrorPageRevoke_subtitle": "Etwas ist bei Ihrem Widerruf fehlgeschlagen",
		"subscriptionSettingsErrorPageRevoke_title": "Fehler beim Widerruf",
		"subscriptionSettingsExpiredState_label": "Abgelaufen",
		"subscriptionSettingsFreePlan_label": "Ein Teil fehlt noch. Erkunde unsere Pläne, um noch mehr Features zu entdecken.",
		"subscriptionSettingsKeep_action": "Abo fortsetzen",
		"subscriptionSettingsKeep_msg": "Ihr Abo wird fortgesetzt. Wir buchen am Ende Ihres aktuellen Abrechnungszeitraums ab. Ist das in Ordnung?",
		"subscriptionSettingsMoreFeatures_action": "Entdecken Sie weitere Features",
		"subscriptionSettingsPlannedState_label": "Geplant",
		"subscriptionSettingsRevokedState_label": "Widerrufen",
		"subscriptionSettingsSubtitle_label": "Auf dieser Seite können Sie Ihr Abo verwalten",
		"subscriptionSettingsSuccessPageCancel_subtitle": "Sie haben Ihr Abo erfolgreich gekündigt",
		"subscriptionSettingsSuccessPageCancel_title": "Kündigungsbestätigung",
		"subscriptionSettingsSuccessPageRevoke_subtitle": "Sie haben Ihr Abo erfolgreich widerrufen",
		"subscriptionSettingsSuccessPageRevoke_title": "Widerrufsbestätigung",
		"subscriptionSettingStorageFeature_label": "Speicherplatz",
		"subscriptionSettingStorageFeature_msg": "Lösche Inhalte, bis Sie unter einem Limit von 1GB sind.",
		"subscriptionSettingSubscriptionOnlyFeatures_title": "Bezahlte Features",
		"subscriptionSettingsUnknownState_label": "Unbekannt",
		"subscriptionSettingSwitchPlan_action": "Abonnement wechseln",
		"subscriptionSettingUsersFeature_label": "Zusätzliche Nutzer",
		"subscriptionSettingUsersFeature_msg": "Falls Sie zusätzliche Nutzer gebucht haben, deaktivieren Sie diese bitte unter Einstellungen > Benutzerverwaltung",
		"subscriptionSettingWhitelabelFeature_label": "Whitelabel",
		"subscriptionSettingWhitelabelFeature_msg": "Falls Sie Whitelabel aktiviert haben, deaktiviere Sie dies bitte unter Einstellungen > Whitelabel",
		"subscriptionStateCardCancel_action": "Abo kündigen",
		"subscriptionStateCardEdit_action": "Abo bearbeiten",
		"subscriptionStateCardEndDate_label": "Enddatum",
		"subscriptionStateCardRenewalDate_label": "Verlängerungsdatum",
		"subscriptionStateCardResubscribe_action": "Neu abonnieren",
		"subscriptionStateCardRevoke_action": "Abo widerrufen",
		...
		"supportDownloadMailApp_msg": "Sobald der Support geantwortet hat, können Sie die Antwort in Ellie Mail mit Ihren Tuta-Kalender-Anmeldedaten abrufen.",
		...
		"transferring_label": "Übertrage…",
		"transfersCompleted_msg": "{done} von {total} erledigt",
		"transfersDone_label": "Fertig",
		"transfersFailed_label": "Fehler",
		"transfersFailed_msg": "Etwas ist schiefgelaufen",
		...
		"useSeparateEndTimeZone_label": "Separate Start- und Endzeitzone",
		...
		"verifyDNSRecords_msg": "Im letzten Schritt müssen Sie die unten aufgelisteten DNS-Einträge einrichten, damit der Ellie Mailserver E-Mails mit Ihrer Domain empfangen und versenden kann.",
